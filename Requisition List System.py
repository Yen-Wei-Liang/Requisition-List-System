...
#left label
Label(obj, text="Lab:", font="arial 13", bg = framebg, fg = framefg).place(x=250, y=160)
Label(obj, text="Student ID:", font="arial 13", bg = framebg, fg = framefg).place(x=250, y=190)
Label(obj, text="Name:", font="arial 13", bg = framebg , fg=framefg).place(x=250, y=220)

#right label
Label(obj, text="Line:", font="arial 13", bg = framebg , fg=framefg).place(x=580, y=160)
Label(obj, text="E-mail:", font="arial 13", bg = framebg , fg=framefg).place(x=580, y=190)
Label(obj, text="Telephone:", font="arial 13", bg = framebg , fg=framefg).place(x=580, y=220)
